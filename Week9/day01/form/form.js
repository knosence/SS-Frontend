...
function handleSubmit(e) {
    ...
    // running our function to create a row using a form data
    createRow(formData);

    // "this" referees to the element that triggered the event, in this case, our form
    this.reset();
}
